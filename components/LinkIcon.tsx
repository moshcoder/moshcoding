const PATHS: Record<string, React.ReactNode> = {
  ...
  spotify: (<>
    <circle cx="12" cy="12" r="10" /><path d="M7.5 9.8c3-.8 6.2-.5 8.8 1M8 13c2.4-.6 4.8-.3 6.8 1M8.6 16c1.8-.4 3.6-.2 5.1.7" fill="none" />
  </>),
  discord: (<>
...
export default function LinkIcon({ kind }: { kind: string }) {
  return (
